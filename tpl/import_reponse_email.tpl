        ...
        <table style="width:90%">
            <tr>
                <td style="width:30%">
                    ...
                    <p class="petit">
                        Mail du support :<br/>
                        <a href="mailto:support@legacy.com">support@legacy.com</a>
                    </p>
                    <br/>
                    <p class="petit">
                ...
                <td style="width:70%">
                    ...
                    N'hésitez pas à nous consulter avec la référence {$id} pour suivre votre demande.<br/>
                    <br/>
                    Cordialement,<br/>
                    Le support de l'LEGACY
                </td>
            </tr>
